...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: yDJluwWq9HjM/css
import SearchSvgIcon from "./icons/PlasmicIcon__SearchSvg"; // plasmic-import: qdWt1NAD8uX2/icon
import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: EzxsFe0Dg_ph/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__z1S2P)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__as5Yt)}
              role={"img"}
            />
          ),
